    ...
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <strong>
         ...
         <a href="add_user.php" class="btn btn-info pull-right">Ajouter nouveau utilisateur</a>
      </div>
      ...
      <table class="table table-bordered table-striped">
        <thead>
          <tr>
            ...
            <th class="text-center" style="width: 15%;">Rôlee</th>
        ...
        <?php foreach($all_users as $a_user): ?>
          <tr>
           ...
           <?php if($a_user['status'] === '1'): ?>
            <span class="label label-success"><?php echo "Activé"; ?></span>
          <?php else: ?>
            <span class="label label-danger"><?php echo "Désactivé"; ?></span>
          <?php endif;?>
           </td>
